...
Si vous ne connaissez pas encore le fonctionnement des modules Thelia, vous pouvez aller lire la [documentation officielle sur les modules Thelia](https://doc.thelia.net/en/documentation/modules/index.html).
...
Des exemples sont disponibles [ici](https://github.com/thelia-modules/TheliaBlocks-plugins-examples).

### Installation des dépendances : 

```bash 
npm install react @thelia/blocks-editor
npm install tsup -D
```
...
import { blocks } from "@thelia/blocks-editor"
...
import { generateId } from "@thelia/blocks-editor"
...
Celle ci est exportée par le package `@thelia/blocks-editor`
